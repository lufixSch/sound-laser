...
For comparison a graph using the same number of transducers in a row ($5$) and the same distance between them ($10.5\,mm$) as the real speaker was created using the results from section \secref{sec:theory:beam}. It is displayed in figure \ref{fig:meas:beam:polar_calc}.
%
\begin{figure}
  \centering
