...
Because of their size and their more focused dispersion characteristics, ultrasonic transducers are used in this project. How audible sound can played over an ultrasonic transducer will be explained in section \secref{sec:theory:mod}.\p
